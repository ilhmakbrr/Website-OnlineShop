...
<div class="project">
    ...
    <form method="get" id="form-input">
        <div class="form-group">
            ...
            <input type="month" class="form-control" id="tanggal" placeholder="Pilih bulan transaksi"  name="tanggal" value="<?php echo isset($_GET['tanggal']) ? $_GET['tanggal'] : ''; ?>" required>
        </div>
        <div class="form-group">
    ...
    // Mengubah format bulan untuk query SQL
    ...
    $sql = "SELECT p.nama, pb.pelanggan_id, pp.pembelian_produk_jumlah, pp.pembelian_produk_harga, pp.pembelian_sub_harga, pb.pembelian_tgl 
            ...
            WHERE DATE_FORMAT(pb.pembelian_tgl, '%Y-%m') = '$bulan'"; 
