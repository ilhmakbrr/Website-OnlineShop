        ...
        <div class="col-12 col-md-6">
            <form action="" method="post">
                ...
                <div class="mt-5 d-flex justify-content-between">
                    <button type="submit" class="btn btn-primary fas fa-edit" name="editBtn">Edit</button>
                    <button type="submit" class="btn btn-danger fas fa-trash" name="deleteBtn">Delete</button>
                </div>
            </form>
